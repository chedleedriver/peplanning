...
if (chosen == "7") {
  ...
  selbox.options[selbox.options.length] = new Option('Trigolf','tri-golf');
    ...
    <div id="wrapper">
        ...
        <table width="985" height="125"  cellpadding="0" cellspacing="0" align="center" border=0>
            <tr><td align="center" style="background: url(index_files/new_bg3.jpg) no-repeat;">
                    
                    


                    <br><br><br><br><br><br><br><table width="400" height="500" border="0" cellpadding="0" cellspacing="0" align="right">
                        <tr><td align="right">
...
<div id="gettingstarted-feature" class="pager pager-with-tabs">
	...
	<div class="pager-content">
        ...
        <div style="display: none;" border="0" class="gettingstarted-feature-contents" id="page-feature-learn">
