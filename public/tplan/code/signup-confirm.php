...
<meta content="" name="page-user-screen_name" />
    <title id="page_title">PE Planning | Sign-up Confirm</title>
...
<div class="content-heading">
  ...
  <h2>PE Planning Registration</h2></div>
     <p><bold>Thank you for registering and welcome to PE Planning</bold>
    </p>
    <p>
        We have sent your login details to your email address.
    </p>
    <p>
