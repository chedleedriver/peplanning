...
<? }
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="content_name" value="<? echo $content_name?>" size="32" maxlength="1024"><input type="hidden" name="content_id" value="<? echo $content_id?>" size="4" /><input type="hidden" name="topic" id="topic" value="<? echo $topic?>"</td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select name="progression_point[0][]" size="5" multiple="multiple"><? GetPoints($topic);?>
      </select>      </td>
    ...
    <tr><td><input type="text" name="progression[1][4]" size="128" maxlength="1024" /></td>
      ...
      <tr><td><input type="text" name="progression[1][6]" size="128" maxlength="1024"  /></td>
        ...
        <tr valign="baseline">	 
	  <td nowrap align="right">Progression Point</td>
      <td><select name="progression_point[1][]" size="5" multiple="multiple"><? GetPoints($topic);?>
      </select>      </td>
    ...
    <tr valign="baseline">
      ...
      <tr><td><input type="text" name="progression[2][6]" size="128" maxlength="1024"  /></td>
        ...
        <tr valign="baseline">	 
	  <td nowrap align="right">Progression Point</td>
      <td><select name="progression_point[2][]" size="5" multiple="multiple"><? GetPoints($topic);?>
      </select>      </td>
    ...
    <tr valign="baseline">
      ...
      <tr><td><input type="text" name="progression[30][6]" size="128" maxlength="1024"  /></td>
        ...
        <tr valign="baseline">	 
	  <td nowrap align="right">Progression Point</td>
      <td><select name="progression_point[3][]" size="5" multiple="multiple"><? GetPoints($topic);?>
      </select>      </td>
