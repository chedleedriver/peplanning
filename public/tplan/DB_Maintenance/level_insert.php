...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `level` (`id`, `description`) VALUES (%s, %s)",
  ...
  $insertGoTo = "level_insert.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
	echo("<meta http-equiv=\"Refresh\" content=\"0;url=/tplan/DB_Maintenance/level_insert.php\">");
}
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" value="Insert record"></td>
	    ...
	    <tr valign="baseline">
      <td nowrap align="right">&nbsp;</td>
      <td><a href="levels.php">Level List</a></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">&nbsp;</td>
