...
$evaluation_update = mysql_query($query_evaluation_update, $tp) or die(mysql_error());
$row_evaluation_update = mysql_fetch_assoc($evaluation_update);
$totalRows_evaluation_update = mysql_num_rows($evaluation_update);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><table>
	  <? $description=unserialize($row_evaluation_update['evaluation']);?>
...
<?php }
mysql_free_result($evaluation_update);
?>
