...
$strand_update = mysql_query($query_strand_update, $tp) or die(mysql_error());
$row_strand_update = mysql_fetch_assoc($strand_update);
$totalRows_strand_update = mysql_num_rows($strand_update);
...
<?php
mysql_free_result($strand_update);
}
?>
