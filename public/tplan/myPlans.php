    ...
    <div id="wrapper">
       <div id="doc" style="background: url(index_files/new_bg3.jpg) no-repeat;">
           <div style="position:absolute;top:30px;left:750px" id="topnav">
               <a href="/tplan/main.php#feature-plans" class="ui-widget">back to home page</a>&nbsp|&nbsp<a href="process.php" class="ui-widget">sign out</a>
           </div>
           <div id="gettingstarted-featured" class="pager pager-with-tabs">
               <div class="gettingstarted-featured-contents" id="page-feature-learn" style="position:absolute;top:200px;left:25px">
                   <table border="0" width="800px">
                       ...
                       <td> <div class="help" style="margin:0 0 20px 20px;position:absolute;right:120px;"><a href='javascript:showHelpDialog("allplans")'>what do I do?&nbsp;</a><img src="/tplan/images/information.gif"></div></td>
                       </tr>
                       <tr>
                           <td align="left"colspan="2">
                               <div id="accordion2" class="basic" >
                                    <? GetAllMyUnits('nofilter',$_SESSION['plan_order']);?>
                               </div>
                           </td>
