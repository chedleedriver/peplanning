...
<div class="content-heading">
  <div class="heading">
     <h2>PEcoach Order Form</h2>

  </div>
</div>

<div id="signup-form" class="">
  <form action="/tplan/process.php" method="post" id="subscribe"><div style="margin:0;padding:0"><input name="subscribe_coach" type="hidden" value="1" /></div>
    <fieldset>
       ...
       <tr class="telephone">
        ...
        <tr class="email-updates">
          ...
          <td colspan="2" class="col-field">
            <div id="invoice"  class="side-section"> <p class="explanation">An invoice for the total subscription cost will be sent to your company address after the first day of the subscription period.  Payment is due within 21 days of the invoice date.</p></div>
        </td>
        </tr>
        <tr class="email-updates">
          <th></th>
