    ...
    function A() {
        ...
        F.find("#school_name").isSignupFormField({
            validateWith: function (H) {
                return isBlank(H) ? _("Should be a school name") : true
            }
        });
       ...
       F.find("#user_password").isSignupFormField({
            validateWith: function (J) {
                return isShort(J) ? _("Should be at least 6 characters and tricky!") : true
            }
        });
        ...
        return this.each(function () {
            ...
            M.isSignupFormField({
                validateWith: function (R) {
                    if (isBlank(R)) {
                        return _("Please enter an user name")
                    } else {
                        P()
                    }
                },
