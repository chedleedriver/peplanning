...
function go(tOut){
		...
		$("#splash").splashQ({
			...
			scripts:
			[
				{name:"Retrieving Unit", src:"/tplan/js/planUnit.js"},
				{name:"Lesson Layouts", src:"/tplan/js/planLessons.js"},
				{name:"Lesson Settings", src:"/tplan/js/planContent.js"},
				{name:"Objectives", src:"/tplan/js/planObj.js"},
				{name:"Activities", src:"/tplan/js/planActivities.js"},
				{name:"Cross-Curricular", src:"/tplan/js/planCco.js"},
				{name:"Lesson Content", src:"/tplan/js/planUi.js"}
			]
		}
	); // end splashscreen
}
...
function changeActivityTabAndMoveOn(changeto,tab,whatTabLabel,updateField,lessonNum,actNum)
{
	...
	var whatTabUrl="code/lessonfunctions.php?GetActivity=" + objNum + "&lesson_num=" + lessonNum +  "&content_id=" + contentId + "&strands=''&teaching_points=''&time=0&plan_type=''&topic_status=''&topic_id=" + topicId + "&theme_id=" + themeId + "&level=" + levelId;
	$('#'+tab+" li:eq(" + whatTabIndex + ") a").html(whatTabLabel);
...
function showHelpDialog(helpTopic)
{
    ...
    urlstring = "code/lessonfunctions.php?GetHelp=" + helpTopic;
...
//	if (window.differentiation_array[lessonNum]) var differentiations=window.differentiation_array[lessonNum][objNum];
    ...
    urlstring = "code/lessonfunctions.php?GetDifferentiation=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentId + "&differentiations=" + window.differentiation_array[lessonNum][objNum];
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
function showProgressionDialog(lessonNum,objNum,contentId)
{
    ...
    urlstring = "code/lessonfunctions.php?GetProgression=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentId + "&progressions=" + window.progression_array[lessonNum][objNum] + "&progression_points=" + progression_points;
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
function showAnalysisDialog(lessonNum,objNum,contentNum)
{
    ...
    urlstring = "code/lessonfunctions.php?GetAnalysis=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentNum + "&topic_id=" + topicId + "&level=" + levelId + "&theme_id=" + window.themeIds[lessonNum] + "&analyses=" + window.analyses_array[lessonNum][objNum] + "&analyses_points=" + analyses_points;
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
function printPlan(planNum,unitId)
{
   ...
   var objectName="plan_print";
    ...
    urlstring = 'code/plan_print.php?lesson_num=' + planNum + '&unit_id=' + unitId;
    objectName.open("GET", urlstring, false);
    objectName.send(null);
}
...
function mainPrintAssessment(VarAssess,VarTopic,VarLevel,VarUnit) {
    ...
    document.location=('/tplan/code/assessment_print.php?assess_id='+ VarAssess + '&topic_id='+ VarTopic + '&level_id=' + VarLevel + '&unit_id=' + VarUnit);
}
