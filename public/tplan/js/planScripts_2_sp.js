...
function changeActivityTabAndMoveOn(changeto,tab,whatTabLabel,updateField,lessonNum,actNum)
{
	...
	var whatTabUrl="code/lessonfunctions_2.php?GetActivity=" + objNum + "&lesson_num=" + lessonNum +  "&content_id=" + contentId + "&strands=''&teaching_points=''&time=0&plan_type=''&topic_status=''&topic_id=" + topicId + "&theme_id=" + themeId + "&level=" + levelId;
	$('#'+tab+" li:eq(" + whatTabIndex + ") a").html(whatTabLabel);
