$(document).ready(function() { 
    	...
    	urlstring = "code/lessonfunctions.php?SetUpLessons=" + window.unitId + "&num_lessons=" + window.numLessons + "&lesson_type=" + window.planType + "&topic_id=" + window.topicId + "&level_id=" + window.levelId + "&original_type=" + window.originalType + "&lesson_num=" + window.lessonNumber + "&_=" + randomnumber;
