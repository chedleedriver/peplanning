...
<?php include("header.php")?>
    <div id="demo-doc"  class="demo">
      <div id="flashContent">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="1280" height="800" id="pep_demo" align="middle">
				...
				<!--[if !IE]>-->
				<object type="application/x-shockwave-flash" data="edit_a_plan.swf" width="1280" height="800">
					<param name="movie" value="pep_demo.swf" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
					<param name="play" value="true" />
