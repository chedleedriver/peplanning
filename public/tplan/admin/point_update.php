...
$point_update = mysqli_query($query_point_update) or die(mysqli_error());
$row_point_update = mysqli_fetch_assoc($point_update);
$totalRows_point_update = mysqli_num_rows($point_update);
...
<?php
mysqli_free_result($point_update);
}
?>
