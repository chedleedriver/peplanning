...
$level_update = mysqli_query($tp, $query_level_update) or die(mysqli_error());
$row_level_update = mysqli_fetch_assoc($level_update);
$totalRows_level_update = mysqli_num_rows($level_update);
...
<?php
mysqli_free_result($level_update); }
?>
