...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO equipment (`description`) VALUES (%s)",
                       GetSQLValueString($_POST['description'], "text"));

  
  $Result1 = mysqli_query($tp, $insertSQL) or die(mysqli_error());

  $insertGoTo = "equipment_insert.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
  // header(sprintf("Location: %s", $updateGoTo));
	echo("<meta http-equiv=\"Refresh\" content=\"0;url=/tplan/DB_Maintenance/equipment_insert.php\">");
}
  ...
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="submit" value="Insert record"></td>
 	    ...
 	    <tr valign="baseline">
      <td nowrap align="right">&nbsp;</td>
      <td><a href="equipments.php">Equipment List</a></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">&nbsp;</td>
