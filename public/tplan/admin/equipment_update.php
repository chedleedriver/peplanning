...
$equipment_update = mysqli_query($tp, $query_equipment_update) or die(mysqli_error());
$row_equipment_update = mysqli_fetch_assoc($equipment_update);
$totalRows_equipment_update = mysqli_num_rows($equipment_update);
...
<?php }
mysqli_free_result($equipment_update);
?>
