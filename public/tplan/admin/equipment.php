...
$equipment = mysqli_query($tp, $query_limit_equipment) or die(mysqli_error());
$row_equipment = mysqli_fetch_assoc($equipment);

if (isset($_GET['totalRows_equipment'])) {
  $totalRows_equipment = $_GET['totalRows_equipment'];
} else {
  $all_equipment = mysqli_query($tp, $query_equipment);
  $totalRows_equipment = mysqli_num_rows($all_equipment);
}
...
<table border="1" align="center">
  ...
  <?php do { ?>
    ...
    <?php } while ($row_equipment = mysqli_fetch_assoc($equipment)); ?>
</table>
<br>
...
Records <?php echo ($startRow_equipment + 1) ?> to <?php echo min($startRow_equipment + $maxRows_equipment, $totalRows_equipment) ?> of <?php echo $totalRows_equipment ?>
