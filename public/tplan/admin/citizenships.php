...
$citizenship = mysqli_query($tp, $query_limit_citizenship) or die(mysqli_error());
...
if (isset($_GET['totalRows_citizenship'])) {
  ...
  $all_citizenship = mysqli_query($tp, $query_citizenship);
  $totalRows_citizenship = mysqli_num_rows($all_citizenship);
}
...
<table border="1" align="center">
  ...
  <?php do { ?>
    <tr>
	  ...
	  <td><label onclick="DeleteTableItem('citizenship',<?php echo $row_citizenship['id'];?>,'<?php echo $_SERVER["PHP_SELF"]?>')">delete</label></td>
    </tr>
...
<?php }
mysqli_free_result($citizenship);
?>
