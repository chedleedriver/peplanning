...
$get_points=mysqli_query("select id,point,point_num from content_point left join point on point.id=point_id where content_id=$content_id order by point_num")or die("Error reported while executing the statement: <br />MySQL reported: ".mysqli_error());
$num_points=0;?>
...
<?php while (list($point_id,$point,$point_num)=mysqli_fetch_array($get_points))
{ 
     ?>
    <tr>
        <td>
