...
<div class="content-heading">
  <div class="heading">
     <h2>PEteacher Order Form</h2>

  </div>
</div>

<div id="signup-form" class="">
  <form action="/tplan/process.php" method="post" id="subscribe"><div style="margin:0;padding:0"><input name="subscribe_teacher" type="hidden" value="1" /></div>
    <fieldset>
       ...
       <tr class="telephone">
        ...
        <tr>
         ...
         <tr class="class-num">
          ...
          <td class="col-field">
              <input name="total_cost" id="total_cost" readonly="yes" class="text_field" value="&pound;72"/>
          </td>
          <td class="col-help">
            <div class="label-box info">
        ...
        <tr>
         ...
         <tr class="sub-from">
          ...
          <td class="col-field">
            <input class="text_field" id="sub-from" maxlength="20" name="sub-from" size="20" tabindex="10" type="text" value="<? echo date("d-m-Y",mktime(0, 0, 0, 9, 1, date("Y")))?>"/>
          </td>
          <td class="col-help">
            <div class="label-box info">
        ...
        <tr class="sub-to">
          ...
          <td class="col-field">
            <input onchange="calculateCosts(this.id)" autocomplete="off" class="text_field" id="sub-to" maxlength="20" name="sub-to" size="20" tabindex="10" type="text" value="<? echo date("d-m-Y",mktime(0, 0, 0, 8, 31, date("Y")+1))?>"/>
          </td>
          <td class="col-help">
            <div class="label-box info">
