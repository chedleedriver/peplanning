...
function doProcess(proc)
{
    ...
    $.post(url, {data:sendData},
        ...
        // failure
            ...
            else if(proc=='usercheck') location.href = "http://" + location.host + "/auth/usercheck?reason=" + response.detail + "&more=" + response.more;
...
function successFunction(proc,response)
{
    ...
    switch(proc) {
        ...
        case 'usercheck':
            ...
            break;
        case 'Logout':
            if(response.unify) location.href='https://sts.platform.rmunify.com/issue/samlSLO/?binding=redirect';
