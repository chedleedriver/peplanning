...
function canIEditThis(unit)
{
    ...
    urlstring = "lessonfunctions_2.php?GetUnit=" + window.unitId + "&user_id="+window.userId+"&user_level="+window.userLevel+"&_=" + randomnumber;
...
//alert("theme id for lesson - "+i+" - "+window.themeIds[i]);
    if(window.themeIds[i]) //test to see whether it is an unplanned lesson
        {    
            var lessonTabUrl="lessonfunctions_2.php?DrawPlanPage2014=" + i + "&theme_id=" + document.getElementById('themeid['+i+']').value + "&topic_id=" + window.topicId + "&level=" + window.levelId + "&uow_id=" + window.unitId + "&objectives=" + window.objectiveIds_array[i] + "&plan_type=" + window.planType;
            
        }
    else 
        {
            if (window.planType=="newPlan") //test for whether it is restricted and has to have a set plan
                {
                    var lessonTabUrl="lessonfunctions_2.php?GetThemes=" + i + "&topic_id=" + window.topicId + "&level=" + window.levelId + "&description=" + window.description + "&num_lessons=" + window.numLessons + "&plan_type=" + window.planType;
                }
            else
                {
                    var lessonTabUrl="lessonfunctions_2.php?GetSetLessons=" + i + "&topic_id=" + window.topicId + "&level=" + window.levelId + "&description=" + window.description + "&num_lessons=" + window.numLessons + "&plan_type=" + window.planType;
                }
...
headingDiv.innerHTML="<table><tr><td rowspan=2 align='left' width=30%><img src='/img/bnb_logo_narrow.jpg' border=0 style=\"cursor:pointer;\" onclick='goHome();' alt='Go Home'></td><td align='left' width=60% valign=\"bottom\" ><label class='ui-widget' style='font-size:18px;font-family: \"Lucida Grande\",Verdana,Sans-serif; font-weight: normal; color:white;'>You are planning to teach " + window.numLessons + " lesson" + addS + " in " + window.topic + " for year " + displayLevel + ".  </label><td align='center' rowspan=2 width=10%><img src='/img/icon_plan_print.png' border=none width=\"30\" height=\"30\" style=\"cursor:pointer\" valign='bottom' onclick='printPlan(0,"+window.unitId+");' alt='Print Plan'><img src='/img/icon_plan_home.png' border=none width=\"30\" height=\"30\" style=\"cursor:pointer\" valign='bottom' onclick='goHome();' alt='Go Home'></td></tr><tr><td align='left' valign='top'><div id='last_save' style='font-size: 10px; font-family: \"Lucida Grande\",Verdana,Sans-serif; font-weight: normal;color:white;'></div></td></tr></table>";
...
for (i = 1 ; i <= window.numLessons ; i++) {
 var options = {
        ...
        success:    doAction,
        url: 'lessonfunctions_2.php?SaveLesson=1&plan_type='+window.planType+'&uow_id='+window.unitId+'&lesson_num='+i,
        type: 'post'
        };
...
function setUpContent()
{
		...
		var randomnumber = Math.floor(Math.random()*1000001);	
    	urlstring = "lessonfunctions_2.php?SetUpLessons=" + window.unitId + "&num_lessons=" + window.numLessons + "&lesson_type=" + window.planType + "&topic_id=" + window.topicId + "&level_id=" + window.levelId + "&set_plan_id=" + window.setPlanId + "&lesson_num=" + window.lessonNumber + "&_=" + randomnumber;
		objectName.open("GET", urlstring, false);
    	objectName.send(null);
...
//				containment: 'parent'
	...
	if (window.activityCount[i]!=0)
	{
                for (c = 1 ; c <= window.activityCount[i] ; c++)
			{
				...
				var actTabUrl="lessonfunctions_2.php?GetActivity=" + objNum + "&lesson_num=" + i +  "&content_id=" + window.activityIds[i][a] + "&strands=" + window.strand_array[i][a] + "&teaching_points=" + window.teaching_point_array[i][a] + "&time=" + window.time[i][a] + "&plan_type=" + window.planType + "&topic_status=" + window.topicStatus + "&topic_id=" + topicId + "&theme_id=" + themeId + "&level=" + window.levelId;
...
//				alert (window.activityIds[i][a]);
	...
	{
		var actTabUrl="lessonfunctions_2.php?GetActivities=1&lesson_num=" + i + "&topic_id=" + topicId + "&level=" + levelId + "&theme_id=" + window.themeIds[i] + "&plan_type=" + window.planType;
	...
	if(window.topicStatus!='R'||window.userLevel==9){
        actTabUrl="lessonfunctions_2.php?GetActivities=" + actNum + "&lesson_num=" + i + "&topic_id=" + topicId + "&level=" + levelId + "&theme_id=" + themeIds[i] + "&plan_type=" + window.planType;
...
function drawCcoTabs(i) // i = lessonNum
{
	...
	if ((window.keywords[i]) && (window.keywords[i].length!=0)) 
		...
		var objTabUrl="lessonfunctions_2.php?GetData=keywords&lesson_num=" + i + "&topic_id=" + window.topicId + "&data=" + window.keywords_array[i] + "&plan_type=" + window.planType;
...
//	$("#ccotabs_"+i).tabs( 'load' , 0 );
	if ((window.citizenship[i]) && (window.citizenship[i].length!=0)) 
		...
		var objTabUrl="lessonfunctions_2.php?GetData=citizenship&lesson_num=" + i + "&topic_id=" + window.topicId + "&data=" + window.citizenship_array[i] + "&plan_type=" + window.planType;
...
//	$("#ccotabs_"+i).tabs( 'load' , 1 );
	if ((window.ict[i]) && (window.ict[i].length!=0)) 
		...
		var objTabUrl="lessonfunctions_2.php?GetData=ict&lesson_num=" + i + "&topic_id=" + window.topicId + "&data=" + window.ict_array[i] + "&plan_type=" + window.planType;
		var objTabLabel="ICT";
		$("#ccotabs_"+i).tabs( 'add' , objTabUrl , objTabLabel );
		var $tabs = $("#ccotabs_"+i).tabs({
    		add: function(event, ui) {
...
//	$("#ccotabs_"+i).tabs( 'load' , 2 );
	if ((window.numeracy[i]) && (window.numeracy[i].length!=0)) 
		...
		var objTabUrl="lessonfunctions_2.php?GetData=numeracy&lesson_num=" + i + "&topic_id=" + window.topicId + "&data=" + window.numeracy_array[i] + "&plan_type=" + window.planType;
...
//	$("#ccotabs_"+i).tabs( 'load' , 3 );
	if ((window.risk_assessment[i]) && (window.risk_assessment[i].length)) 
		...
		var objTabUrl="lessonfunctions_2.php?GetData=risk_assessment&lesson_num=" + i + "&topic_id=" + window.topicId + "&data=" + window.risk_assessment_array[i] + "&plan_type=" + window.planType;
...
function drawLessonLayout(themeId,lessonNum,themeName)
{
	...
	var themeTabUrl="lessonfunctions_2.php?DrawPlanPage2014=" + lessonNum + "&theme_id=" + themeId  + "&topic_id=" + topicId + "&level=" + levelId + "&uow_id=" + window.unitId + "&objectives=" + window.objectiveIds_array[i] + "&plan_type=newPlan";
...
function drawSetLessonLayout(lessonId,themeId,lessonNum,themeName)
{
	...
	setUpContent();
	var themeTab = $('#tabs').tabs();
	var themeTabUrl="lessonfunctions_2.php?DrawPlanPage2014=" + lessonNum + "&theme_id=" + themeId  + "&topic_id=" + topicId + "&level=" + levelId + "&uow_id=" + window.unitId + "&objectives=" + window.objectiveIds_array[i] + "&lesson_id=" + lessonId + "&plan_type=setPlan";
	var themeTabLabel='Lesson '+lessonNum+'. '+themeName;
	if ($('#tabs').tabs('length')==1) {
		var themeTabIndex=0; }
	else if (themeIds[lessonNum]) {
...
function unDrawLessonLayout(lessonNum)
{
        ...
        if (oldPlan)
	{
		...
		var themeTab = $('#tabs').tabs();
		if (window.levelId>0) {
		var themeTabUrl="lessonfunctions_2.php?GetThemes=" + lessonNum + "&topic_id=" + window.topicId + "&level=" + window.levelId + "&description=" + window.description + "&num_lessons=" + window.numLessons; }
		else {
		var themeTabUrl="lessonfunctions_2.php?GetSetLessons=" + lessonNum + "&topic_id=" + window.topicId + "&level=" + window.levelId + "&description=" + window.description + "&num_lessons=12"; 
		}
		...
		themeTab.tabs('load',themeTabIndex);
                var options = {
                                ...
                                url: 'lessonfunctions_2.php?SaveLesson=1&plan_type='+window.planType+'&uow_id='+window.unitId+'&lesson_num='+lessonNum,
                                type: 'post'
                              };
...
function deleteLesson(lessonNum)
{
    ...
    var randomnumber = Math.floor(Math.random()*1000001);
    urlstring = 'lessonfunctions_2.php?DeleteLesson=1&uow_id='+window.unitId+'&lesson_num='+lessonNum+'&_=' + randomnumber;
...
function getDisplayLevel(level)
{
	...
	if (level==1){return "1";}
	if (level==2){return "2";}
	if (level==2.5){return "3";}
	if (level==3){return "4";}
	if (level==3.5){return "5";}
	if (level==4){return "6";}
}
...
function changeActivityTabAndMoveOn(changeto,tab,whatTabLabel,updateField,lessonNum,actNum,planType)
{
	...
	var whatTabUrl="lessonfunctions_2.php?GetActivity=" + objNum + "&lesson_num=" + lessonNum +  "&content_id=" + contentId + "&strands=''&teaching_points=''&time=0&plan_type=" + planType + "&topic_status=''&topic_id=" + topicId + "&theme_id=" + themeId + "&level=" + levelId;
...
/*				alert (dump(window.objectiveIds[lessonNum]));
				...
				//objectiveNum=parseInt(objectiveId)+1;
                                if (ie)
                                    ...
                                    {
                                      strandDiv.innerHTML=strandDiv.innerHTML+'<li><a class=\'ui-widget\' href=../tplan/js//"#/">'+window.objectives[lessonNum][objectiveId]+"</a></li>";
                                    }
...
function showHelpDialog(helpTopic)
{
    ...
    urlstring = "lessonfunctions_2.php?GetHelp=" + helpTopic;
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
//	if (window.differentiation_array[lessonNum]) var differentiations=window.differentiation_array[lessonNum][objNum];
    ...
    urlstring = "lessonfunctions_2.php?GetDifferentiation=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentId + "&differentiations=" + window.differentiation_array[lessonNum][objNum];
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
function showProgressionDialog(lessonNum,objNum,contentId)
{
    ...
    urlstring = "lessonfunctions_2.php?GetProgression=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentId + "&progressions=" + window.progression_array[lessonNum][objNum] + "&progression_points=" + progression_points;
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
function showAnalysisDialog(lessonNum,objNum,contentNum)
{
    ...
    urlstring = "lessonfunctions_2.php?GetAnalysis=" + lessonNum + "&content_id=" + objNum + "&obj_num=" + contentNum + "&topic_id=" + topicId + "&level=" + levelId + "&theme_id=" + window.themeIds[lessonNum] + "&analyses=" + window.analyses_array[lessonNum][objNum] + "&analyses_points=" + analyses_points;
    objectName.open("GET", urlstring, true);
    objectName.send(null);
...
alert (objectName.responseText);
    	...
    	urlstring = "basefunctions.php?GetMyUnits=1";
    	objectName.open("GET", urlstring, true);
    	objectName.send(null);
}
            ...
            var response=eval(msg);
                ...
                $.ajax({
                    ...
                    if (popUp == null || typeof(popUp)=='undefined') {   
                        jInform('<p>You are not allowing popup windows from our site.</p><p>In order to print you must enable popups</p><p>You can go to our <a href="/learn/faqs">FAQ area</a> to learn how to do this or you can download a copy of the plan <a href="../tplan/js/'+msg+'">here</a></p>'); 
                        }
                    else {   
                        setTimeout( function() {
