...
class Application_Form_UnsetplanForm extends Zend_Form
{
    ...
    public function init()
    {
       ...
       $level->addMultiOptions( array(99 => 'Select NC Level','0.0' => 'Foundation','1.0' => 'Level 1','1.5'=> 'Level 1/2','2.0' => 'Level 2','2.5' => 'Level 2/3','3.0' => 'Level 3','3.5' => 'Level 3/4','4.0' => 'Level 4'))
             ->setOrder(1);

       $ownplan_level_overlay = $this->createElement('text', 'ownplan_level_overlay', array('class' => 'hidechrome', 'value'=>'Select NC Level'))
               ->setAttrib('readonly', 'readonly');


       $topic = $this->createElement('select','own_sel_topic',array('class' => 'styled-select'));
       $topic->addMultiOptions( array(0 => 'Select NC Level'))
             ->setOrder(2);
