...
class Application_Form_PaymentForm extends Pay_Table_Form
{
    ...
    public function startform()
    {
       ...
       $classnum_payment =  $this->createElement('text', 'classnum_payment',array('label' => ''  ));
       $classnum_payment->addFilters(array('StringTrim'))
           ->setValue('number of classes')
           ->setRequired(true)
           ->setOptions(array(
               'onfocus'=>'if(this.value=="number of classes")this.value="";', 
               'onblur'=>'if(this.value=="")this.value="number of classes";' 
               ));
       $this->addElement($classnum_payment);
       $classnum_payment_msg =  $this->createElement('text', 'classnum_payment_msg',array('class' => 'error'  ))
               ->setAttrib('readonly', 'readonly')
               ->setAttrib('style', 'display: none');
       $this->addElement($classnum_payment_msg);
    }
}
